...
### This web application have capable of managing,
* [x] Sign up User
* [x] Login User
* [x] Forget Password/ Reset Password
* [x] Verify User by Email
* [x] View Available Users with Online Status
* [x] Realtime Chat

### The features that are available in this Web Application,
* [x] Custom PHP MVC Architecture with routes
* [x] Reliable and Fast Realtime Chat
* [x] Simple and Lite User Interface

```
Creative Commons Legal Code

Copyright (c) 2023 Sandun Prasanna(Root Genesis)
...
1. Definitions
 ...
 f. "Work" means the literary and/or artistic work offered under the terms
    ...
    extent it is protected as a copyright-able work; or a work performed by
...
subject to and limited by the following restrictions:
 ...
 c. If You Distribute, or Publicly Perform the Work or Collections, You
    ...
    attribution ("Attribution Parties") in Licensors copyright notice,
 ...
 e. Except as otherwise agreed in writing by the Licensor or as may be
    ...
    to the Original Authors honor or reputation.
...
Creative Commons may be contacted at https://creativecommons.org/licenses/by-nc-nd/3.0/.
```